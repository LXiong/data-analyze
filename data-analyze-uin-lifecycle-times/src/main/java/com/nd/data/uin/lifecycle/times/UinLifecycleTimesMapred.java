 ...
 * @author aladdin
 */
public class UinLifecycleTimesMapred {
            ...
            if (value != null) {
                ...
                if (leave01Cnt.isEmpty()) {
                    ...
                    if (leaveDays <= 1) {
                        ...
                        this.updateLeaveCnt(LeaveTypeEnum.LEAVE01, product, uin, loginCnt);
                    }
                }
                //判断用户是否已7日流失
                if (leave07Cnt.isEmpty()) {
                    ...
                    if (leaveDays <= 7) {
                        ...
                        this.updateLeaveCnt(LeaveTypeEnum.LEAVE07, product, uin, loginCnt);
                    }
                }
                //判断用户是否已14日流失
                if (leave14Cnt.isEmpty()) {
                    ...
                    if (leaveDays <= 14) {
                        ...
                        this.updateLeaveCnt(LeaveTypeEnum.LEAVE14, product, uin, loginCnt);
                    }
                }
                //判断用户是否已30日流失
                if (leave30Cnt.isEmpty()) {
                    ...
                    if (leaveDays <= 30) {
                        ...
                        this.updateLeaveCnt(LeaveTypeEnum.LEAVE30, product, uin, loginCnt);
                    }
                }
            }
        }
