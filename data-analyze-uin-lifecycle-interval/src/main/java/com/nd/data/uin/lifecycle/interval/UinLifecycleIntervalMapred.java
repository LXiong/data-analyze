            ...
            if (value != null) {
                ...
                if (leave01Date.isEmpty()) {
                    ...
                    if (leaveDays <= 1) {
                        ...
                        this.updateLeaveDate(LeaveTypeEnum.LEAVE01, product, uin, lastDate);
                    }
                }
                //判断用户是否已7日流失
                if (leave07Date.isEmpty()) {
                    ...
                    if (leaveDays <= 7) {
                        ...
                        this.updateLeaveDate(LeaveTypeEnum.LEAVE07, product, uin, lastDate);
                    }
                }
                //判断用户是否已14日流失
                if (leave14Date.isEmpty()) {
                    ...
                    if (leaveDays <= 14) {
                        ...
                        this.updateLeaveDate(LeaveTypeEnum.LEAVE14, product, uin, lastDate);
                    }
                }
                //判断用户是否已30日流失
                if (leave30Date.isEmpty()) {
                    ...
                    if (leaveDays <= 30) {
                        ...
                        this.updateLeaveDate(LeaveTypeEnum.LEAVE30, product, uin, lastDate);
                    }
                }
            }
        }
