...
/**
 * Created with IntelliJ IDEA. User: Lin QiLi Date: 14-2-18 Time: 下午2:16
 */
/**
 * The same part for each htable record to be inserted or updated
 */
public class ImeiProductUser {
